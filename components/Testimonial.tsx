...
interface TestimonialProps extends React.HTMLAttributes<HTMLDivElement> {
  ...
  quote: string;
  authorName: string;
  authorPosition: React.ReactNode;
  authorImage?: string;
      ...
      >
        <div className="max-w-screen-xl mx-auto px-4 lg:px-8">
          <div className="flex flex-col items-center">
            ...
            <p 
              className="max-w-3xl text-balance text-center text-md sm:text-lg text-foreground"
            ...
            <h5 className="mt-5 font-bold text-foreground">
              {authorName}
            </h5>
            <h5 className="mt-1.5 font-medium text-foreground/80">
              {authorPosition}
            </h5>
          </div>
        </div>
